...
export default function ProductForm({ initial = {}, onSave, saving = false }) {
  ...
  function gatherValues() {
    ...
    return {
      title, description, price: Number(price || 0), mrp: Number(mrp || 0),
      stock: Number(stock || 0), sku, brand, category, sizes, colors
    };
  }
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 220px", gap: 12 }}>
        ...
        <div>
          ...
          <div style={{ marginTop: 16 }}>
            ...
            <button type="button" onClick={() => { /* caller handles navigation */ }} style={{ padding: "8px 16px" }}>Cancel</button>
          </div>
        </div>
      </div>
    </form>
